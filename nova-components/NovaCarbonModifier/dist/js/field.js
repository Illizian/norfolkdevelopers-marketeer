...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-carbon-modifier', __webpack_require__(3));
  Vue.component('detail-nova-carbon-modifier', __webpack_require__(6));
  Vue.component('form-nova-carbon-modifier', __webpack_require__(9));
});
...
var MODIFIERS = [['year', 'Set Year', true], ['month', 'Set Month', true], ['day', 'Set Day', true], ['hour', 'Set Hour', true], ['minute', 'Set Minute', true], ['second', 'Set Second', true], ['addCenturies', 'Add Centuries', true], ['subCenturies', 'Sub Centuries', true], ['addYears', 'Add Years', true], ['subYears', 'Sub Years', true], ['addQuarters', 'Add Quarters', true], ['subQuarters', 'Sub Quarters', true], ['addMonths', 'Add Months', true], ['subMonths', 'Sub Months', true], ['addDays', 'Add Days', true], ['subDays', 'Sub Days', true], ['addWeekdays', 'Add Weekdays', true], ['subWeekdays', 'Sub Weekdays', true], ['addWeeks', 'Add Weeks', true], ['subWeeks', 'Sub Weeks', true], ['addHours', 'Add Hours', true], ['subHours', 'Sub Hours', true], ['addMinutes', 'Add Minutes', true], ['subMinutes', 'Sub Minutes', true], ['addSeconds', 'Add Seconds', true], ['subSeconds', 'Sub Seconds', true], ['addMilliseconds', 'Add Milliseconds', true], ['subMillisecond', 'Sub Millisecond', true], ['addMicroseconds', 'Add Microseconds', true], ['subMicroseconds', 'Sub Microseconds', true], ['startOfCentury', 'Start Of Century', false], ['endOfCentury', 'End Of Century', false], ['startOfDecade', 'Start Of Decade', false], ['endOfDecade', 'End Of Decade', false], ['startOfYear', 'Start Of Year', false], ['endOfYear', 'End Of Year', false], ['startOfMonth', 'Start Of Month', false], ['endOfMonth', 'End Of Month', false], ['startOfWeek', 'Start Of Week', false], ['endOfWeek', 'End Of Week', false], ['startOfDay', 'Start Of Day', false], ['endOfDay', 'End Of Day', false], ['startOfHour', 'Start Of Hour', false], ['endOfHour', 'End Of Hour', false], ['startOfMinute', 'Start Of Minute', false], ['endOfMinute', 'End Of Minute', false], ['next', 'Next', true], ['previous', 'Previous', true]];
    ...
    methods: {
        ...
        */
        setInitialValue: function setInitialValue() {
            this.modifiers = this.field.value ? this.field.value.split(',') : [];
        },
        ...
        */
        ...
        removeModifier: function removeModifier(index) {
            this.modifiers = this.modifiers.filter(function (modifier, key) {
                return key !== index;
            });
        },
        addModifiers: function addModifiers(modifiers) {
            this.modifiers.push.apply(this.modifiers, modifiers.split(','));
        },
        addModifier: function addModifier(modifier) {
            if (!modifier) {
                var method = this.config[this.selected][0];
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "flex" }, [
          _c(
            "select",
            {
              ...
              staticClass: "form-control form-select w-2/3",
              on: {
            ...
            [
              ...
              _vm._v(" "),
              _vm._l(_vm.config, function(ref, i) {
                var key = ref[0]
                var label = ref[1]
                var hasParams = ref[2]
                return _c("option", { key: key, domProps: { value: i } }, [
                  _vm._v(
                    "\n                  " + _vm._s(label) + "\n              "
                  )
                ])
          ...
          _vm._v(" "),
          _c("div", { staticClass: "flex w-1/3 pl-2" }, [
            _c(
              "div",
              {
                directives: [
                  {
                    ...
                    rawName: "v-show",
                    value:
                      _vm.config[_vm.selected] && _vm.config[_vm.selected][2],
                    expression: "config[selected] && config[selected][2]"
                  }
                ],
                staticClass: "flex"
              },
              [
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.config[_vm.selected],
                        expression: "config[selected]"
                      }
                    ],
                    staticClass:
                      "form-prepend rounded-l-lg px-2 text-sm font-bold"
                  },
                  [
                    _vm._v(
                      "\n                      " +
                        _vm._s(
                          _vm.config[_vm.selected]
                            ? _vm.config[_vm.selected][0]
                            : ""
                        ) +
                        ":\n                  "
                    )
                ...
                _c("input", {
                  ...
                  staticClass:
                    "bg-white border border-60 px-3 text-80 rounded-lg rounded-l-none outline-none",
                  attrs: { type: "text" },
            ...
            _c(
              "button",
              {
                ...
                staticClass: "px-2 text-xl font-bold text-blue-500",
                attrs: { type: "button" },
                on: {
                  click: function($event) {
                    return _vm.addModifier()
                  }
                }
              },
              [_vm._v("\n                  +\n              ")]
        ...
        _c(
          ...
          [
            _c("li", { staticClass: "inline-block" }, [
              _c("label", { staticClass: "help-text font-semibold" }, [
                _vm._v("\n                  Popular:\n              ")
              ])
            ]),
            _vm._v(" "),
            _vm._l(_vm.popular, function(modifiers, key) {
              return _c("li", { key: key, staticClass: "inline-block mr-2" }, [
                _c(
                  "a",
                  {
                    staticClass: "help-text no-underline hover:underline",
                    attrs: { href: "#" },
                    on: {
                      click: function($event) {
                        return _vm.addModifiers(modifiers)
                      }
                    }
                  },
                  [
        ...
        _c(
          "ol",
          { staticClass: "mt-2 p-0" },
          _vm._l(_vm.modifiers, function(modifier, key) {
            return _c(
              "li",
              {
                key: key,
                staticClass:
                  "inline-block mr-2 mb-2 px-3 py-1 bg-gray-200 rounded-full text-sm font-semibold text-gray-700"
              },
              [
                _vm._v(
                  "\n              " + _vm._s(modifier) + "\n              "
